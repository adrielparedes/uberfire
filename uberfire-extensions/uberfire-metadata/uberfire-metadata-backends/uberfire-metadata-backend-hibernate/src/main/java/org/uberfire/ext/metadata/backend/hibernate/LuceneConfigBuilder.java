...
import org.uberfire.ext.metadata.backend.hibernate.fields.FieldFactory;
import org.uberfire.ext.metadata.backend.hibernate.fields.SimpleFieldFactory;
import org.uberfire.ext.metadata.backend.hibernate.index.CustomAnalyzerWrapperFactory;
import org.uberfire.ext.metadata.backend.hibernate.index.LuceneIndex;
import org.uberfire.ext.metadata.backend.hibernate.index.directory.DirectoryFactory;
import org.uberfire.ext.metadata.backend.hibernate.index.directory.DirectoryType;
import org.uberfire.ext.metadata.backend.hibernate.metamodel.InMemoryMetaModelStore;
