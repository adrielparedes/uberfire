...
import static org.uberfire.ext.metadata.backend.hibernate.index.Serializer.toByteArray;
    ...
    public IndexableField[] build(final KProperty<?> property) {
        ...
        if (Enum.class.isAssignableFrom(property.getValue().getClass())) {
            if (property.isSearchable()) {
                return new IndexableField[]{new TextField(getName(property),
                                                          property.getValue().toString().toLowerCase(),
                                                          Field.Store.YES)};
            }
            return new IndexableField[]{new StringField(getName(property),
                                                        property.getValue().toString().toLowerCase(),
                                                        Field.Store.YES)};
        }
        ...
        if (property.getValue().getClass() == String.class) {
            if (property.isSortable()) {
                return new IndexableField[]{new SortedDocValuesField(getName(property),
        ...
        if (property.getValue().getClass() == Integer.class) {
            if (property.isSearchable()) {
                return new IndexableField[]{new IntField(getName(property),
                                                         (Integer) property.getValue(),
                                                         Field.Store.YES)};
            }
            return new IndexableField[]{new StoredField(getName(property),
                                                        (Integer) property.getValue())};
        }

        if (property.getValue().getClass() == Long.class) {
            if (property.isSearchable()) {
                return new IndexableField[]{new LongField(getName(property),
        ...
        if (property.getValue().getClass() == Double.class) {
            if (property.isSearchable()) {
                return new IndexableField[]{new DoubleField(getName(property),
        ...
        if (property.getValue().getClass() == Float.class) {
            if (property.isSearchable()) {
                return new IndexableField[]{new FloatField(getName(property),
        ...
        if (Collection.class.isAssignableFrom(property.getValue().getClass())) {
            ...
            for (final Object ovalue : (Collection) property.getValue()) {
