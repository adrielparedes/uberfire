...
public class ConfigurationManager {
    ...
    public MetadataSearchConfigurationBase getSearchConfiguration() {
        String indexManager = this.preferences.getIndexManager();

        MetadataSearchConfigurationBase configurationBase;
        switch (indexManager) {
            case "lucene":
                configurationBase = luceneConfiguration;
                break;
            case "elasticsearch":
                configurationBase = elasticSearchConfiguration;
                break;
            default:
                configurationBase = luceneConfiguration;
        }
