...
import org.uberfire.ext.metadata.backend.hibernate.index.LuceneIndexEngine;
import org.uberfire.ext.metadata.backend.hibernate.index.LuceneIndexFactory;
import org.uberfire.ext.metadata.backend.hibernate.index.LuceneIndexManager;
import org.uberfire.ext.metadata.backend.hibernate.search.LuceneSearchIndex;
