...
public class Fork extends GitCommand {
    ...
    public Optional<Void> execute() {
        ...
        final File gitClonedFolder = new File( parentFolder, target );
        JGitUtil.cloneRepository( gitClonedFolder, gitSource.getPath(), true, credentialsProvider );
